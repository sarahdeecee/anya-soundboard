...
function MobileMenu(props) {
  ...
  return (<>
    ...
    >
      ...
      <BottomNavigationAction label={(theme.language === 'japanese') ? '選択' : 'Select'} icon={<FilterAlt />} onClick={() => setMode('select')} />
      <BottomNavigationAction label={(theme.language === 'japanese') ? '気に入り' : 'Favorites'} icon={<Favorite />} onClick={() => setMode('faves')} />
