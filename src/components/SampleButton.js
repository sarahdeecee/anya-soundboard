...
function SampleButton(props) {
  const {theme, english, romaji, japanese, keypress, file, picture, showTransition, setShowTransition, selectedSamples, setSelectedSamples, mode, setOpenSampleText} = props;
